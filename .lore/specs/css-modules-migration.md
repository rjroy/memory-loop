...
> **Note**: This migration was attempted on 2026-02-14 but aborted due to implementation failures. See `.lore/retros/css-modules-migration-failure.md` for lessons learned.
