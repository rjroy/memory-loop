 ...
 */
export function VideoViewer({ path, assetBaseUrl, onMobileMenuClick, onDelete }: VideoViewerProps): ReactNode {
    ...
    <div className="video-viewer">
      <div className="video-viewer__header">
        ...
        {onDelete && (
          <button
            type="button"
            className="video-viewer__delete-btn"
            onClick={onDelete}
