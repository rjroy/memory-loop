...
describe("Server -> Client Messages", () => {
  ...
  describe("HealthCategorySchema", () => {
    ...
    test("rejects invalid category", () => {
      ...
      expect(() => HealthCategorySchema.parse("sync")).toThrow(ZodError);
  ...
  describe("HealthIssueSchema", () => {
    const validIssue = {
      ...
      category: "vault_config" as const,
      message: "Failed to parse vault configuration",
    ...
    test("accepts valid health issue", () => {
      ...
      expect(result.category).toBe("vault_config");
      expect(result.message).toBe("Failed to parse vault configuration");
    ...
    test("accepts all valid categories", () => {
      const categories = ["vault_config", "file_watcher", "cache", "general"] as const;
